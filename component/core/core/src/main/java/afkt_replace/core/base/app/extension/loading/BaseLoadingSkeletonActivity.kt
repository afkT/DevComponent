 ...
 */
abstract class BaseLoadingSkeletonActivity<VDB : ViewDataBinding, VM : afkt_replace.core.base.app.BaseViewModel> : afkt_replace.core.base.app.BaseAppActivity<VDB, VM> {
