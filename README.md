...
<p align="center">
	<b>
		<a href="https://github.com/afkT/DevComponent/blob/therouter/USE_GUIDE.md">使用说明</a>
	</b>、
	<b>
		<a href="https://github.com/afkT/DevComponent/blob/therouter/USE_CHANNEL.md">多渠道打包</a>
	</b>
</p>
...
<p align="center">
	<b>
		<a href="https://github.com/afkT/DevComponent/blob/therouter/USE_RUN.md">运行说明</a>
	</b>
</p>
...
### [目录](https://github.com/afkT/DevComponent/blob/therouter/component)
...
> 该 [Core Module](https://github.com/afkT/DevComponent/blob/therouter/component/core/core) 基于 [Dev 系列开发库](https://github.com/afkT/DevUtils) 搭建，
...
### [目录](https://github.com/afkT/DevComponent/blob/therouter/application)
...
主要技术点为在 [modular.gradle](https://github.com/afkT/DevComponent/blob/therouter/file/gradle/modular.gradle) 中定义标识
...
根据标识，应用不同的[构建文件](https://github.com/afkT/DevComponent/blob/therouter/file/gradle/build/build_module.gradle)。
...
* [config.gradle](https://github.com/afkT/DevComponent/blob/therouter/file/gradle/config.gradle) ：主要存储第三方库版本信息等

* [versions.gradle](https://github.com/afkT/DevComponent/blob/therouter/file/gradle/versions.gradle) ：构建信息以及 core 库版本配置

* [modular.gradle](https://github.com/afkT/DevComponent/blob/therouter/file/gradle/modular.gradle) ：组件化配置以及各个 Module 版本信息
...
- [多渠道打包](https://github.com/afkT/DevComponent/blob/therouter/USE_CHANNEL.md)
